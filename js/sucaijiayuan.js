...
function drawCld(SY,SM) {
   ...
   for(i=0;i<42;i++) {
      ...
      sObj.className = '';
      sD = i - cld.firstWeek;
      bgOjb.style.background='';
      if(sD>-1 && sD<cld.length) { //日期内
         sObj.innerHTML = sD+1;
		 if(cld[sD].isToday){ sObj.style.color = '#FFFFFF';bgOjb.style.background='#f14537';} //今日颜色
		 else{sObj.style.color = '';bgOjb.style.background='';}
